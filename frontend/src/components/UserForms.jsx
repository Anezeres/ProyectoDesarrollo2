        ...
        <div className="flex justify-center items-center bg-gradient-to-br from-amber-600 to-amber-300 h-screen">
            <div className="bg-white w-[75%] h-[55%] flex justify-center items-center rounded-xl">
                <div className="w-1/2 h-[100%] z-10 flex flex-col justify-center items-center">
                    <h2 className="font-sans font-bold text-4xl mb-5px">¿Ya tienes tu cuenta?</h2>
                    <button onClick={handleFormChange} className="bg-amber-600 text-white mt-5 text-center rounded-xl text-3xl font-semibold p-3">Iniciar Sesion</button>
                </div>
                <div className="w-1/2 h-[100%] z-10 flex flex-col justify-center items-center">
                    <h2 className="font-sans font-bold text-4xl mb-5px">¿Aún no tienes una cuenta?</h2>
                    <button onClick={handleFormChange} className="bg-amber-600 text-white mt-5 text-center rounded-xl text-3xl font-semibold p-3">Registrarse</button>
                </div>
